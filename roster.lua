...
function ReRecount:CheckPartyCombatWithPets()
...
function ReRecount:GetPetPrefixUnit(name)
...
function ReRecount:FindTargetedUnit(name)
...
function ReRecount:FindOwnerPetFromGUID(petName,petGUID)
	local ownerName
	local ownerGUID
